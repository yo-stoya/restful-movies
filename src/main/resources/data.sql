...
values ('Lumiere and Company (LumiГЁre et compagnie)', 21, 1),
       ...
       ('Rabid Grannies (MГ©mГ©s cannibales, Les)', 20, 21),
       ('Tea For Two', 22, 22),
       ...
       ('LГ©on: The Professional (a.k.a. The Professional) (LГ©on)', 19, 62),
       ('Place in the Sun, A (En plats i solen)', 46, 63),
       ('Viper in the Fist', 14, 64),
       ('Sex Is Comedy', 47, 65),
       ('MetsГ¤n tarina', 11, 66),
       ...
       ('Four more years (Fyra ГҐr till)', 48, 148),
       ...
       ('Beau Geste', 7, 185),
       ('Mysteries of Lisbon (MistГ©rios de Lisboa)', 30, 186),
       ('Once Around', 35, 187),
       ...
       ('No habrГЎ paz para los malvados', 40, 275),
       ('Chronicles (CrГіnicas)', 37, 276),
